...
/**
 * Crimping wire-completion % — denominator is Crimping Required only.
 * Re-exported from crimping.ts so callers can import from kpi.constants.
 */
export { crimpingWirePercent, summarizeCrimpingKpis } from './crimping';
