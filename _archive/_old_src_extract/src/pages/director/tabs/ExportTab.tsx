...
export default function ExportTab({ stats }: ExportTabProps) {
  ...
  return (
    <div>
      <div className="export-grid">
        <div className="export-card">
          <div className="export-head">
            <div className="export-icon success">📊</div>
            <div>
          ...
          <div className="export-list">
            {EXPORT_SHEETS.map(s => (
              <div key={s.title} className="export-list-row">
                <span className="export-list-bullet success">↗</span>
                <div>
          ...
          <button onClick={() => doExport('xlsx')} disabled={!!exporting} className="dwes-button dwes-button-success export-btn" type="button">
        ...
        <div className="export-card">
          <div className="export-head">
            <div className="export-icon progress">📄</div>
            <div>
          ...
          <div className="export-list">
            {['KPI Summary section', 'Projects table', 'Workforce table'].map(s => (
              <div key={s} className="export-list-row">
                <span className="export-list-bullet progress">↗</span>
          ...
          <button onClick={() => doExport('csv')} disabled={!!exporting} className="dwes-button dwes-button-progress export-btn" type="button">
        ...
        <div className="export-card">
          <div className="export-head">
            <div className="export-icon danger">📋</div>
            <div>
          ...
          <div className="export-list">
            {['KPI Summary with gauges', 'Project progress table', 'Workforce table'].map(s => (
              <div key={s} className="export-list-row">
                <span className="export-list-bullet danger">↗</span>
                <span className="export-list-row-copy">{s}</span>
              </div>
            ))}
          ...
          <button onClick={() => doExport('pdf')} disabled={!!exporting} className="dwes-button dwes-button-danger export-btn" type="button">
      ...
      {error && (
        <div className="dwes-error mb-md">
          {error}
        </div>
      )}
          ...
          <div className="export-snapshot-grid">
            {[
              ...
              <div key={k.label} className="export-snapshot-card">
                ...
                <div className="export-snapshot-item-label mt-xxs">{k.label}</div>
              </div>
            ))}
          </div>
        </div>
