var __dsPreview = (() => {
  ...
  function WithActions() {
    return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: { minWidth: 560 }, children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
      ds_exports.SectionHeader,
      {
        title: "Technician Dashboard",
        description: "Frames assigned to you for the current shift, with live wiring progress.",
        icon: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ds_exports.Icon, { name: "dashboard", filled: true }),
        actions: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ds_exports.Button, { variant: "primary", children: "New session" })
      }
    ) });
  }
  function Plain() {
