      ...
      <div className="p-6">
        ...
        {precheck && (
          <div className="mb-5">
            ...
            <div className="text-[12px] text-slate-500 flex items-start gap-1.5 mb-4">
              ...
              {!result ? (
                <>
                  {modalPrecheckLoading ? (
                    <div className="py-8 text-center text-[13px] text-slate-500">Loading project details…</div>
                    ...
                    <>
                      ...
                      <div className="rounded-xl border border-slate-200 bg-slate-50 p-4 mb-4 text-[13px] text-slate-700">
                        <div className="font-semibold text-slate-800 mb-2">{modalPrecheck.project.name}</div>
                ...
                <div className="text-center">
                  ...
                  <div className="text-[16px] font-bold text-slate-800 mb-2">Reset complete</div>
