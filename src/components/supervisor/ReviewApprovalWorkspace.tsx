...
export default function ReviewApprovalWorkspace({ isActive = true }: { isActive?: boolean }) {
  ...
  const [crimpingPanel, setCrimpingPanel] = useState<PanelRow | null>(null);
  ...
  return (
    <div className="sup-status">
        ...
        <>
          ...
          <section className="sup-overview" aria-label="Panel overview">
            ...
            <div className="sup-overview-foot">
              ...
              <div className="sup-overview-foot-row">
                ...
                {selectedRow.assignmentId != null ? (
                  <button
                    type="button"
                    className="sup-btn-compact"
                    onClick={() => setCrimpingPanel(selectedRow)}
                    title="Select wires that require Crimping before Wiring"
                  >
                    Crimping Required
                  </button>
                ) : null}
      ...
      {crimpingPanel?.assignmentId != null && (
        <CrimpingRequiredModal
          assignmentId={crimpingPanel.assignmentId}
          panelName={crimpingPanel.panelName}
          onClose={() => setCrimpingPanel(null)}
          onSaved={() => { void loadWorkspaceData({ silent: true }); }}
        />
      )}
