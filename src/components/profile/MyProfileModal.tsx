      ...
      {!done ? (
        <div className="flex flex-col gap-4">
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className="flex flex-col gap-1.5">
              <label className="text-[12px] font-medium text-slate-600 uppercase tracking-[0.06em]">Employee ID</label>
          ...
          <div className="border-t border-[#E2E8F0] pt-4">
            <p className="text-[12px] font-semibold uppercase tracking-wide text-slate-500 mb-3">Change Password (optional)</p>
            <div className="grid grid-cols-2 gap-4">
        ...
        <div className="flex flex-col items-center gap-3 py-6 text-center">
          ...
          <div className="text-[16px] font-bold text-slate-800">Profile updated</div>
          <div className="text-[13px] text-slate-500">Your changes have been saved.</div>
        </div>
      )}
    </Modal>
  );
