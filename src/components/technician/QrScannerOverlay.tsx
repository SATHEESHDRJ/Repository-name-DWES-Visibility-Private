  ...
  return (
    <div className="qr-scan-overlay show" role="presentation">
      <div className="qr-scan-box" role="dialog" aria-modal="true" aria-label={title}>
        ...
        <div className="qr-status text-[12px] font-semibold mt-2 text-slate-500">{status}</div>
        ...
        >
          ...
          <div className="flex items-center justify-center gap-2 text-[12px] font-semibold text-slate-600">
            <Upload size={14} />
